...
deepNet = DeepContourNet(cost="fuse", sample_size=225)
data_provider = segmentation_provider.SegmentationDataProvider("/data/Cell/norm_data/training_data/",
                                                               "/data/Cell/norm_data/test_data/", resample=False,
                                                               sample_number=3000, sample_size=225)

trainer = Trainer(deepNet, batch_size=1, optimizer="adam", learning_rate=0.001, decay_rate=0.9, decay_step=100000)
trainer.train_unet(data_provider, "/data/Cell/yunzhe/cross_entropy/", training_iters=120000, epochs=101,
