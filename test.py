...
for i in range(5):
    ...
    mask, contour = net.predict("/home/cell/yunzhe/miccai_code/model/model.ckpt70", input, mask_label, mask_contour)
...
#     plt.show()
#     mask, contour = net.predict("/home/cell/yunzhe/miccai_code/model/model.ckpt70", train_data,
